...
-- 4. Bảng Project_Keyword (Many-to-Many)
...
-- 5. Bảng Subject_Category_Project
...
-- 10. Bảng Journal_Ranking_Subject_Category (Many-to-Many)
...
CREATE TABLE "Publisher" (
  ...
  "display_name" nvarchar,
  "image_url" varchar,
  "created_at" timestamp DEFAULT CURRENT_TIMESTAMP, -- Đổi từ datetime để chạy được trong PostgreSQL
...
CREATE TABLE "Author" (
  ...
  "works_count" bigint,  -- Đổi sang bigint cho khớp DB thực tế và OpenAlex
  "cited_by_count" bigint,  -- Đổi sang bigint
  "h_index" bigint,  -- Đổi sang bigint
  "i10_index" bigint,  -- Đổi sang bigint
...
-- 25. Bảng staging raw_scimago_journal
